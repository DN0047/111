...
<html lang="zh-CN">
  ...
  <body>
        ...
        <div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">
			<div class="panel panel-default">
				  <div class="panel-heading">
					...
					<div class="panel-heading">
						<img id="showimg" alt="流程定义图片" src="${pageContext.request.contextPath }/jquery/layer/skin/default/loading-1.gif">
				    </div>
	...
	<script src="${pageContext.request.contextPath}/jquery/pagination/jquery.pagination.js"></script>
