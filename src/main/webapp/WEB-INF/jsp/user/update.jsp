			  ...
			  <div class="panel-body">
				<form id="updateForm">
				  <div class="form-group">
					...
					<input type="text" class="form-control" id="floginacct" value="${sessionScope.user.loginacct }">
				  </div>
				  <div class="form-group">
					<label for="fusername">用户名称</label>
					<input type="text" class="form-control" id="fusername" value="${sessionScope.user.username }">
				  </div>
				  <div class="form-group">
					<label for="femail">邮箱地址</label>
					<input type="email" class="form-control" id="femail" value="${sessionScope.user.email }">
